...
const TEAMS = {
    ...
    "galle-gallants":   { name: "Galle Gallants",   short: "GAG", color: "#1B7A3D", bg: "#0A3518", titles: null, strength: "Aggressive top order, spin-friendly home conditions",     aiRating: 76, league: "LPL", competition: "Lanka Premier League 2026" },
    ...
    "kandy-royals":     { name: "Kandy Royals",     short: "KRL", color: "#6A1B9A", bg: "#2E0B44", titles: 1,    strength: "Hasaranga-led attack, suited to Pallekele conditions",     aiRating: 79, league: "LPL", competition: "Lanka Premier League 2026" },
            ...
            <div style={{ maxWidth: 860, margin: "0 auto", padding: "36px 20px 80px" }}>
                ...
                <div style={{ background: "#fff", border: "1px solid #E2E8F0", borderRadius: 14, padding: "20px 24px", marginBottom: 24 }}>
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: 14 }}>
                        {[
                            ["🤖", "ML Model", "XGBoost trained on a decade of T20 data. 81.5% on unseen 2025-2026 matches."],
