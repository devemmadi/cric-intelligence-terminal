...
const MOCK_MATCHES = [
    { id: 1, t1: "INDIA", t2: "AUSTRALIA", status: "LIVE", day: "T20", detail: "2nd T20I ÃÂÃÂ· Wankhede", t1Score: 156, t2Score: null, t1Wkts: 3, matchId: null },
    { id: 2, t1: "ENGLAND", t2: "PAKISTAN", status: "UPCOMING", day: "ODI", detail: "1st ODI ÃÂÃÂ· Lord's", t1Score: null, t2Score: null, matchId: null },
    { id: 3, t1: "NZ", t2: "SA", status: "UPCOMING", day: "TEST", detail: "Cape Town ÃÂÃÂ· Day 1", t1Score: null, t2Score: null, matchId: null },
];
const MOCK_PRED = {
    ...
    currentPhase: "MIDDLE OVERS", phaseEmoji: "ÃÂ°ÃÂÃÂÃÂ¡",
    ...
    nextOvers: [
        { over: 15, phase: "MIDDLE OVERS", expectedRuns: 9.2, wicketProb: 22, confidence: 85, runRange: "7ÃÂ¢ÃÂÃÂ11", tip: "ÃÂ°ÃÂÃÂÃÂ¡ Build platform heading into death overs. Target 10 runs minimum." },
        { over: 16, phase: "DEATH OVERS", expectedRuns: 10.8, wicketProb: 32, confidence: 77, runRange: "9ÃÂ¢ÃÂÃÂ13", tip: "ÃÂ°ÃÂÃÂÃÂ´ Death begins ÃÂ¢ÃÂÃÂ high scoring expected. Yorkers key." },
        { over: 17, phase: "DEATH OVERS", expectedRuns: 11.5, wicketProb: 38, confidence: 69, runRange: "9ÃÂ¢ÃÂÃÂ14", tip: "ÃÂ°ÃÂÃÂÃÂ´ Slog overs ÃÂ¢ÃÂÃÂ boundaries crucial. Spin bowlers under pressure." },
        { over: 18, phase: "DEATH OVERS", expectedRuns: 10.2, wicketProb: 42, confidence: 61, runRange: "8ÃÂ¢ÃÂÃÂ13", tip: "ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ Wicket risk rising. Batters taking high-risk shots." },
        { over: 19, phase: "DEATH OVERS", expectedRuns: 12.0, wicketProb: 45, confidence: 53, runRange: "10ÃÂ¢ÃÂÃÂ14", tip: "ÃÂ°ÃÂÃÂÃÂ´ Final push ÃÂ¢ÃÂÃÂ maximum attack. Expect big hits." },
    ],
    weather: { temp: 28, condition: "SUNNY" },
    weatherImpact: { tip: "Bright conditions favour batters.", emoji: "ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ" },
    dataSource: "877 venues ÃÂÃÂ· 1.7M records ÃÂÃÂ· 78.2% accuracy",
    overHistory: [{ over: 10, runs: 98 }, { over: 11, runs: 108 }, { over: 12, runs: 119 }, { over: 13, runs: 133 }, { over: 14, runs: 156 }],
    powerplay: { expectedScore: 58, expectedRR: 9.6, tip: "Strong powerplay ÃÂ¢ÃÂÃÂ batting conditions ideal." },
        ...
        try {
            ...
            if (list.length) {
                const mapped = list.slice(0, 8).map((m, i) => ({
                    ...
                    status: m.status?.includes("won") || m.status?.includes("Won") ? "ENDED" : (m.matchStarted && !m.matchEnded) || m.status?.includes("need") || m.status?.includes("opt") || m.status?.includes("batting") || m.status?.includes("over") ? "LIVE" : "UPCOMING",
...
function fixObj(obj) {
  ...
  return obj;
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ LANDING ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    if (showLanding) return (
        <div style={{ minHeight: "100vh", background: "#F9F9F9", fontFamily: "Inter, -apple-system, system-ui", color: C.text }}>
            <style>{CSS}</style>

            {/* Hero ÃÂ¢ÃÂÃÂ Blue with pitch texture */}
            <div style={{ background: "#354D97", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ maxWidth: 700, margin: "0 auto", padding: "50px 32px 60px", position: "relative" }}>
                    <div style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "rgba(200,150,30,0.15)", border: "1px solid rgba(200,150,30,0.4)", borderRadius: 20, padding: "5px 14px", marginBottom: 24 }}>
                        ...
                        <span style={{ fontSize: 12, fontWeight: 700, color: "#C8961E", letterSpacing: 0.5 }}>LIVE ÃÂÃÂ· IPL 2025 READY</span>
                    </div>
                    ...
                    <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 10 }}>
                        ...
                        <button onClick={() => { if (emailInput) localStorage.setItem("cricintel_email", emailInput); localStorage.setItem("ci_v2", "1"); setShowLanding(false); }}
                            ...
                            Get Free Predictions ÃÂ¢ÃÂÃÂ
                        </button>
                    </div>
                    <div style={{ fontSize: 12, color: "rgba(255,255,255,0.35)" }}>Free ÃÂÃÂ· No credit card ÃÂÃÂ· Cancel anytime</div>
                </div>
            </div>

            {/* Stats + Preview ÃÂ¢ÃÂÃÂ White */}
            <div style={{ maxWidth: 700, margin: "0 auto", padding: "32px 24px 60px" }}>
                ...
                <div style={{ background: "#fff", border: "1px solid #E8E8E8", borderRadius: 16, padding: 22 }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8 }}>
                        {[["Next over", "9ÃÂ¢ÃÂÃÂ11 runs", "#0A0A0A"], ["Wicket risk", "Low ÃÂÃÂ· 22%", "#22C55E"], ["Confidence", "High ÃÂÃÂ· 85%", "#C8961E"]].map(([k, v, color]) => (
        ...
        // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ MAIN APP ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    return (
        <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "Inter, -apple-system, system-ui", color: C.text }}>
            ...
            <nav style={{ background: C.navy, borderBottom: `1px solid ${C.navyLight}`, padding: "0 20px", height: 54, display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 100 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    {!isPremium && <button onClick={() => setShowPaywall(true)} style={{ background: C.gold, color: C.navy, border: "none", borderRadius: 8, padding: "7px 14px", fontSize: 12, fontWeight: 700, cursor: "pointer" }}>Upgrade ÃÂ¢ÃÂÃÂ¡</button>}
                </div>
            </nav>
                ...
                <div className="mg fade" style={{ display: "grid", gridTemplateColumns: "260px 1fr 240px", minHeight: "calc(100vh - 54px)" }}>
                    ...
                    <aside className="sl" style={{ borderRight: `1px solid ${C.border}`, padding: "18px 14px", overflowY: "auto", background: C.surface }}>
                        <div style={{ fontSize: 10, fontWeight: 700, color: C.navy, letterSpacing: 1.5, marginBottom: 12, padding: "6px 10px", background: `${C.navy}10`, borderRadius: 8, display: "inline-block" }}>
                            {liveStatus==="live" ? "ÃÂ°ÃÂÃÂÃÂ¢ LIVE DATA" : "ÃÂ¢ÃÂÃÂ MATCHES"}
                        </div>
                        {liveMatches.map(m => (
                            <div key={m.id} className={`match-pill ${selectedMatch.id===m.id?"sel":""}`} onClick={() => setSelectedMatch(m)}>
                                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
                                    <span style={{ fontSize: 10, color: C.muted }}>{m.day} ÃÂÃÂ· {m.detail?.split("ÃÂÃÂ·")[0]?.trim().slice(0,20)}</span>
                                    <span style={{ fontSize: 9, fontWeight: 700, padding: "1px 6px", borderRadius: 5, background: m.status==="LIVE"?"#FFF0F0":C.bg, color: m.status==="LIVE"?C.red:C.muted }}>
                                        {m.status==="LIVE"?"ÃÂ¢ÃÂÃÂ LIVE":m.status}
                                    </span>
                                </div>
                    ...
                    <main className="mc" style={{ padding: 0, overflowY: "auto" }}>
                        ...
                        <div style={{ background: "#354D97", position: "relative", overflow: "hidden", padding: "24px 24px 28px" }}>
                            ...
                            <div style={{ position: "relative", textAlign: "center" }}>
                                ...
                                <div style={{ display: "inline-flex", alignItems: "center", gap: 14, background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.18)", borderRadius: 10, padding: "8px 18px" }}>
                                    ...
                                    <button onClick={() => { const t = `ÃÂ°ÃÂÃÂÃÂ ${cleanTeam(pred.team1 || "India")} vs ${cleanTeam(pred.team2 || "Australia")} ÃÂ¢ÃÂÃÂ AI: ${prob}% win probability. cricintelligence.com`; navigator.clipboard?.writeText(t).then(() => alert("Copied! ÃÂ°ÃÂÃÂÃÂ")); }}
                                        style={{ background: "none", border: "none", cursor: "pointer", fontSize: 11, color: "#C8961E", fontWeight: 700 }}>Share ÃÂ¢ÃÂÃÂ</button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14 }}>
                                    ...
                                    <div>
                                        ...
                                        {(pred.weaknesses||MOCK_PRED.weaknesses).map(w => (
                                            <div key={w} style={{ fontSize:11,marginBottom:5,display:"flex",gap:5 }}><span style={{ color:C.red }}>ÃÂ¢ÃÂÃÂ</span>{w}</div>
                                        ))}
                                    </div>
                                </div>
                                {!isPremium
                                    ? <button onClick={() => setShowPaywall(true)} className="btn-p" style={{ fontSize:12 }}>Unlock Full Analysis ÃÂ¢ÃÂÃÂ ÃÂÃÂ£9.99/mo</button>
                        ...
                        <div className="cr" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:14,marginBottom:14 }}>
                            <div className="card" style={{ padding:18,display:"flex",gap:14,alignItems:"center" }}>
                                <span style={{ fontSize:32 }}>{pred.weatherImpact?.emoji||"ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ"}</span>
                                <div>
                                    <div style={{ fontSize:10,fontWeight:700,color:C.muted,letterSpacing:1 }}>WEATHER</div>
                                    <div style={{ fontSize:20,fontWeight:800 }}>{pred.weather?.temp||28}ÃÂÃÂ°C</div>
                                    <div style={{ fontSize:11,color:C.muted }}>{pred.weather?.condition||"SUNNY"}</div>
                                </div>
                            </div>
                            <div className="card" style={{ padding:18,display:"flex",gap:14,alignItems:"center" }}>
                                <span style={{ fontSize:32 }}>ÃÂ°ÃÂÃÂÃÂ</span>
                                <div>
                        ...
                        <div className="card" style={{ padding:22,marginBottom:14 }}>
                            <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14 }}>
                                ...
                                {!isPremium && <span style={{ fontSize:11,color:C.accent,fontWeight:600 }}>1 free ÃÂÃÂ· Upgrade for all 5</span>}
                            </div>
                                    ...
                                    return (
                                        <div key={i} className={`over-card ${activeOver===i?"sel":""}`} onClick={() => setActiveOver(i)}>
                                            ...
                                            <div style={{ background:`${wc}15`,borderRadius:6,padding:"4px 4px" }}>
                                                <div style={{ fontSize:9,fontWeight:700,color:wc }}>{ov.wicketProb>40?"ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ Likely":ov.wicketProb>25?"Possible":"Safe"}</div>
                        ...
                        <div className="cr" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:14 }}>
                            <div className="card" style={{ padding:18 }}>
                                <div style={{ fontSize:10,fontWeight:700,color:C.muted,letterSpacing:1,marginBottom:10 }}>ÃÂ°ÃÂÃÂÃÂµ POWERPLAY</div>
                            ...
                            <div className="card" style={{ padding:18,position:"relative",overflow:"hidden" }}>
                                <div style={{ fontSize:10,fontWeight:700,color:C.muted,letterSpacing:1,marginBottom:10 }}>ÃÂ°ÃÂÃÂÃÂ´ DEATH OVERS</div>
                                ...
                                {!isPremium && <div className="lock" onClick={() => setShowPaywall(true)}><span style={{ fontSize:18 }}>ÃÂ°ÃÂÃÂÃÂ</span><span style={{ fontSize:10,fontWeight:600 }}>Premium</span></div>}
                            </div>
                        </div>
                    ...
                    <aside className="sr" style={{ borderLeft:`1px solid ${C.border}`,padding:"18px 14px",background:C.surface,display:"flex",flexDirection:"column",gap:14 }}>
                        ...
                        {!isPremium && (
                            <div style={{ background:C.text,borderRadius:14,padding:16,color:"#fff" }}>
                                <div style={{ fontSize:13,fontWeight:700,marginBottom:6 }}>ÃÂ¢ÃÂÃÂ¡ Unlock Premium</div>
                                <div style={{ fontSize:11,color:"rgba(255,255,255,0.65)",lineHeight:1.5,marginBottom:12 }}>All 5 overs ÃÂÃÂ· Death intel ÃÂÃÂ· Pitch tracker ÃÂÃÂ· Real-time signals</div>
                                <button onClick={() => setShowPaywall(true)} style={{ width:"100%",background:C.gold,color:C.text,border:"none",borderRadius:8,padding:"9px",fontSize:13,fontWeight:700,cursor:"pointer" }}>
                                    From ÃÂÃÂ£9.99/mo
                                </button>
                            </div>
                        )}
                        <div style={{ fontSize:10,color:C.muted,lineHeight:1.6,textAlign:"center",marginTop:"auto" }}>
                            {pred.dataSource||"877 venues ÃÂÃÂ· 1.7M records"}<br />
                            <span style={{ color:C.red,fontWeight:600 }}>18+ ÃÂÃÂ· BeGambleAware.org</span>
                        </div>
                    </aside>
                </div>
            )}
            ...
            {activeTab === "matches" && (
                <div className="fade" style={{ maxWidth:600,margin:"0 auto",padding:"22px 16px" }}>
                    <div style={{ fontSize:20,fontWeight:800,marginBottom:18 }}>{liveStatus==="live"?"ÃÂ°ÃÂÃÂÃÂ¢ Live Matches":"Matches"}</div>
                    {liveMatches.map(m => (
                        <div key={m.id} className="card" style={{ padding:18,marginBottom:12,cursor:"pointer" }} onClick={() => { setSelectedMatch(m); setActiveTab("predict"); }}>
                            <div style={{ display:"flex",justifyContent:"space-between",marginBottom:12 }}>
                                <span style={{ fontSize:11,color:C.muted }}>{m.day} ÃÂÃÂ· {m.detail}</span>
                            ...
                            <div style={{ fontSize:12,color:C.accent,fontWeight:600,marginTop:4 }}>View AI Prediction ÃÂ¢ÃÂÃÂ</div>
                        </div>
                    ))}
                </div>
            )}
            ...
            {activeTab === "media" && (
                <div className="fade" style={{ maxWidth:600,margin:"0 auto",padding:"22px 16px" }}>
                    ...
                    {[
                        ...
                        { tag:"STATS", title:"India's batting in death overs ÃÂ¢ÃÂÃÂ a deep dive", time:"6h ago" },
            ...
            {/* MOBILE NAV */}
            <nav className="mn">
                {[["ÃÂ°ÃÂÃÂÃÂ","Predict","predict"],["ÃÂ°ÃÂÃÂÃÂ","Matches","matches"],["ÃÂ°ÃÂÃÂÃÂº","Media","media"],["ÃÂ¢ÃÂÃÂ¡","Upgrade","up"]].map(([icon,label,key]) => (
                ...
                <div style={{ position:"fixed",inset:0,background:"rgba(0,0,0,0.5)",zIndex:300,display:"flex",alignItems:"flex-end" }} onClick={() => setShowPaywall(false)}>
                    <div style={{ width:"100%",maxWidth:500,margin:"0 auto",background:C.surface,borderRadius:"20px 20px 0 0",padding:26 }} onClick={e=>e.stopPropagation()}>
                        <div style={{ textAlign:"center",marginBottom:22 }}>
                            <div style={{ fontSize:22,marginBottom:8 }}>ÃÂ¢ÃÂÃÂ¡</div>
                            <div style={{ fontSize:21,fontWeight:800,marginBottom:6 }}>Unlock Premium</div>
                            <div style={{ fontSize:13,color:C.muted }}>All 5 over predictions ÃÂÃÂ· Death overs intel ÃÂÃÂ· Pitch tracker</div>
                        </div>
                        {paymentStep==="plans" && (
                            <>
                                <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14 }}>
                                    {[{plan:"monthly",price:"ÃÂÃÂ£9.99",per:"/mo",label:"Monthly",sub:"Cancel anytime"},{plan:"annual",price:"ÃÂÃÂ£59.99",per:"/yr",label:"Annual ÃÂ¢ÃÂÃÂ",sub:"Save 50%"}].map(p => (
                                        <div key={p.plan} onClick={() => setSelectedPlan(p.plan)}
                                            ...
                                            <div style={{ fontSize:11,color:C.muted }}>{p.per} ÃÂÃÂ· {p.sub}</div>
                                        </div>
                                    ))}
                                </div>
                        ...
                        {paymentStep==="email" && (
                            <>
                                ...
                                <button className="btn-p" onClick={() => handleCheckout(selectedPlan)} disabled={checkingPayment}>
                                    {checkingPayment?"Loading...":`Pay ${selectedPlan==="annual"?"ÃÂÃÂ£59.99/yr":"ÃÂÃÂ£9.99/mo"}`}
                                </button>
                            </>
                        )}
                        <div style={{ textAlign:"center",marginTop:10,fontSize:11,color:C.muted }}>18+ ÃÂÃÂ· Gamble responsibly ÃÂÃÂ· BeGambleAware.org</div>
