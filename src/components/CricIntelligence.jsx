                                ...
                                <div style={{ padding: "20px 24px" }}>
                                    ...
                                    <div className="card" style={{ padding: 22, marginBottom: 14 }}>
                                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
                                            <div>
                                                <div style={{ fontSize: 10, fontWeight: 700, color: C.muted, letterSpacing: 1 }}>NEXT 5 OVERS PREDICTION</div>
                                                ...
                                                return (
                                                    <div key={i} className={`over-card ${activeOver === i ? "sel" : ""}`} onClick={() => setActiveOver(i)}>
                                                        ...
                                                        <div style={{ background: `${wc}15`, borderRadius: 6, padding: "4px 4px" }}>
                                                            <div style={{ fontSize: 9, fontWeight: 700, color: wc }}>{ov.wicketProb > 40 ? "Likely" : ov.wicketProb > 25 ? "Possible" : "Safe"}</div>
                                    ...
                                    <div className="cr" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                                        <div className="card" style={{ padding: 18 }}>
                                            ...
                                            <div style={{ fontSize: 22, fontWeight: 800 }}>{pred.powerplay?.expectedScore || ""} runs</div>
                                        ...
                                        <div className="card" style={{ padding: 18, position: "relative", overflow: "hidden" }}>
                                            ...
                                            <div style={{ fontSize: 22, fontWeight: 800 }}>{pred.deathOvers?.expectedRR || ""} RR</div>
